export const Header = ({ onClickCart, onClickHeart, totalCost }) => {
  return (
    <header className="d-flex justify-between align-center p-40">
      <div className="d-flex align-center">
        ...
        <div>
          ...
          <p className="opacity-5"> Магазин лучших кросссовок </p>
        </div>
      </div>
      <ul className="d-flex">
        ...
        <li className="mr-20 cu-p" onClick={() => onClickHeart(true)}>
